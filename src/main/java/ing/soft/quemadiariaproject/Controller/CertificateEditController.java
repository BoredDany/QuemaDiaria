...
public class CertificateEditController {
    ...
    public void saveInstitution(ActionEvent actionEvent) {
        try{
            ...
            errInstitLabel.setText(e.getMessage());
        }
    }
    ...
    public void saveExpDate(ActionEvent actionEvent) {
        try{
            CertificateDTO old = CentralController.getCertificateDTO();
            CertificateDTO newCertificate = new CertificateDTO(old.getTrainerUsername(), old.getInstitution(), getStringDate(), old.getDescription(), old.getLink(), old.getTitle());
            certificateFacade.modifyCertificate(CentralController.getCertificateDTO(), newCertificate);
            errDateLabel.setText("Date modified and saved");
        } catch (TrainerException e){
            errDateLabel.setText(e.getMessage());
        }
    }
    ...
    public String getStringDate(){
        ...
        if(expDateField.getValue() != null){
            LocalDate selectedDate = expDateField.getValue();
    ...
    public void saveDescription(ActionEvent actionEvent) {
        try{
            ...
            errDescriptLabel.setText(e.getMessage());
        }
    }
    ...
    public void saveLink(ActionEvent actionEvent) {
        try{
            ...
            errLinkLabel.setText(e.getMessage());
        }
    }
