...
public class EmailSender {
    ...
    public static void sendConfirmationEmail(String toEmail, int code) {
        ...
        try {
            ...
            message.setText("Gracias por registrarte en nuestra aplicación. Tu código de confirmación es: " + code);
